...
let
  ...
  src = fetchFromGitHub {
    ...
    rev = "v${version}";
    hash = "sha256-lwBhjxTLPIyizOYY7tCqnfYB5YlG4g0QUnKqKXL1HTI=";
  };
  ...
  npmDeps_ui = fetchNpmDeps {
    name = "npm-deps-ui";
    src = "${src}/ui";
    hash = "sha256-4VhVbHAUcysUI0cYJhgoEWr53JfPIak/l6VfTbR0igE=";
  };
in
buildNpmPackage rec {
  ...
  npmDepsHash = "sha256-21HeqCkEBvJeejzbciY8a2TeSQ+YDHOz/Ac6ajsjJSE=";
