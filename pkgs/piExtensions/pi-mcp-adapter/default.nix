...
buildPiExtension {
  ...
  src = fetchFromGitHub {
    owner = "nicobailon";
    repo = "pi-mcp-adapter";
    rev = "49e25be1cb917329980eb7a40786c5b91dddb277";
    sha256 = "sha256-IRsK/D66M+MZ5X4RSmXkaq9De7akoVlorEWuEdx9eo0=";
  };
  ...
  npmDepsHash = "sha256-y2pBtBOVkh4f5BGn2A+aFOwlIhdpE+T7zafTh+A7JcQ=";
}
