...
buildPiExtension {
  ...
  src = fetchFromGitHub {
    owner = "nicobailon";
    repo = "pi-mcp-adapter";
    rev = "14c0e6cd45acdf4c8e4c188b3dccea1b4c80471b";
    sha256 = "sha256-j/sIYOpLSLC95vFVutjJONguiTCWxw2sVkCYX19v2Ek=";
  };
  ...
  npmDepsHash = "sha256-4oNAK+n8/tmoaqNwAWLnxe3RjqWY+leP7GP9gu4Ygok=";
}
