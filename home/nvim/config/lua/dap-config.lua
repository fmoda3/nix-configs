...
require('legendary').bind_keymaps({
    ...
    { '<Leader>duf', function() require("dap.ui.widgets").centered_float(require("dap.ui.widgets").scopes) end, description = 'DAP: Widgets scopes', opts = opts },
    { '<Leader>dsbr', function() vim.ui.input({ prompt = 'Breakpoint condition', default = ''}, function(input) require("dap").set_breakpoint(input) end) end, description = 'DAP: Set breakpoint condition', opts = opts },
    { '<Leader>dsbm', function() vim.ui.input({ prompt = 'Log point message', default = ''}, function(input) require("dap").set_breakpoint(nil, nil, input) end) end, description = 'DAP: Log message', opts = opts },
    ...
    { '<Leader>dco', require('telescope').extensions.dap.configurations, description = 'DAP: Show configurations', opts = opts },
    { '<Leader>dlb', require('telescope').extensions.dap.list_breakpoints, description = 'DAP: Show breakpoints', opts = opts },
    ...
    { '<Leader>dev', function() vim.ui.input({ prompt = 'Eval', default = ''}, function(input) require("dapui").eval(input, { enter = true }) end) end, description = 'DAP: Evaluate expression', opts = opts }
})
