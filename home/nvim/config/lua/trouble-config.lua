...
require('legendary').bind_keymaps({
    ...
    { '<Leader>xr', '<cmd>TroubleRefresh<cr>', description = 'Trouble: Close', opts = opts },
	{ '<Leader>xw', '<cmd>Trouble workspace_diagnostics<cr>', description = 'Trouble: Workspace diagnostics', opts = opts },
	{ '<Leader>xd', '<cmd>Trouble document_diagnostics<cr>', description = 'Trouble: Document diagnostics', opts = opts },
