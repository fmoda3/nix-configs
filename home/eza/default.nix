{
  programs.eza = {
    ...
    # Catppuccin Frappe Blue theme
    # https://github.com/catppuccin/eza
    theme = {
      colourful = true;

      filekinds = {
        normal = { foreground = "#c6d0f5"; };
        directory = { foreground = "#8caaee"; };
        symlink = { foreground = "#8caaee"; };
        pipe = { foreground = "#b5bfe2"; };
        block_device = { foreground = "#ea999c"; };
        char_device = { foreground = "#ea999c"; };
        socket = { foreground = "#b5bfe2"; };
        special = { foreground = "#ca9ee6"; };
        executable = { foreground = "#a6d189"; };
        mount_point = { foreground = "#81c8be"; };
      };
      ...
      punctuation = { foreground = "#737994"; };
      date = { foreground = "#e5c890"; };
      inode = { foreground = "#a5adce"; };
      blocks = { foreground = "#737994"; };
